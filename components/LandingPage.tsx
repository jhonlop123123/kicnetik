...
import { Wallet, Fingerprint, ScanFace, ArrowRight, ShieldCheck, Zap, TrendingUp, Diamond } from 'lucide-react';
      ...
      <div className="relative z-20 w-full max-w-lg p-6 flex flex-col items-center">
        ...
        <div className="mb-12 flex flex-col items-center animate-in fade-in slide-in-from-top-8 duration-1000">
          <div className="relative w-24 h-24 mb-6 group">
             {/* Logo Glow */}
             <div className="absolute inset-0 bg-amber-500/30 blur-2xl rounded-full group-hover:bg-amber-400/40 transition-all duration-700"></div>
             
             {/* Logo SVG - Abstract K / Diamond / Play Button */}
             <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-2xl relative z-10">
                ...
                {/* Outer Hexagon Ring */}
                <path d="M50 5 L93 29 V71 L50 95 L7 71 V29 Z" fill="none" stroke="url(#goldGrad)" strokeWidth="2" className="opacity-50" />
                
                {/* Inner Solid Shape */}
                <path d="M35 30 L75 50 L35 70 Z" fill="url(#goldGrad)" className="drop-shadow-lg" />
                <path d="M35 30 L35 70 L25 50 Z" fill="#B45309" />
             </svg>
          </div>
        ...
        <div className="w-full backdrop-blur-xl bg-slate-950/40 border border-amber-500/20 rounded-3xl shadow-[0_0_40px_rgba(245,158,11,0.05)] overflow-hidden relative">
          ...
          {/* STEP 3: PROFILE SETUP (GOLD THEME) */}
          {currentStep === 'profile' && (
